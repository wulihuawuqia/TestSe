...
public class Ex14 {
	...
	public static void m2(Exam exam) { exam.w();System.out.println(exam.k); }
	public static void m3(Labs labs) { labs.y(); System.out.println(labs.k);} 
